...
hi('StartifyBracket',  gui03, nil, cterm03, nil, nil, nil)
hi('StartifyFile',     gui07, nil, cterm07, nil, nil, nil)
hi('StartifyFooter',   gui03, nil, cterm03, nil, nil, nil)
hi('StartifyHeader',   gui0B, nil, cterm0B, nil, nil, nil)
hi('StartifyNumber',   gui09, nil, cterm09, nil, nil, nil)
hi('StartifyPath',     gui03, nil, cterm03, nil, nil, nil)
hi('StartifySection',  gui0E, nil, cterm0E, nil, nil, nil)
hi('StartifySelect',   gui0C, nil, cterm0C, nil, nil, nil)
hi('StartifySlash',    gui03, nil, cterm03, nil, nil, nil)
hi('StartifySpecial',  gui03, nil, cterm03, nil, nil, nil)
